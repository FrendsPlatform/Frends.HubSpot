...
namespace Frends.HubSpot.GetContacts.Helpers
{
    ...
    public static class ErrorHandler
    {
        ...
        /// <returns>
        /// Object { bool Success, JToken Contacts, bool HasMore, string NextPageCursor, Error Error { string Message, Exception AdditionalInfo } }
        /// </returns>
        public static Result Handle(Exception ex, bool throwError, string customMessage)
        {
            ...
            return new Result(false, null, false, null, error);
        }
    }
}
